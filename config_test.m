...
SEG.nC = 150; % taget number of super pixels
...
SEG_FILE = [DATA_DIR, 'segmented_150.mat'];
...
DATA_FILE = [ DATA_DIR, 'data_150.mat'];
TRAIN_DATA = [ DATA_DIR, 'train_150.mat'];
TEST_DATA = [ DATA_DIR, 'test_150.mat'];
...
TRAIN.libsvm_options = '-t 0 -c 1'; % linear, 
...
MODEL_FILE = [ DATA_DIR, 'models_150.mat'];
